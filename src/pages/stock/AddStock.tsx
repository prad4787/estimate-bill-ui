    ...
    <div className="space-y-8 animate-fade-in">
        ...
        <div className="page-header">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-2">Create a new stock item for inventory management.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card">
        <div className="card-header">
          ...
          <p className="text-gray-600 mt-1">Fill in the details below to add a new stock item to your inventory.</p>
        </div>
