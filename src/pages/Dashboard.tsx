...
const Dashboard: React.FC = () => {
  ...
  const totalOpeningBalance = clients.reduce(
    (sum, client) => sum + client.openingBalance,
    0
  );
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="stats-card bg-gradient-to-br from-blue-600 to-blue-700 text-white border-0">
          <div className="text-center">
            ...
            <Link
              to="/estimates/add"
              className="btn bg-white text-blue-600 hover:bg-gray-100 w-full"
            >
              New Estimate
            </Link>
          </div>
            ...
            {clients.length === 0 ? (
              <div className="empty-state py-12">
                ...
                <p className="text-gray-500 mb-6">
                  Add your first client to get started with estimates and
                  billing.
                </p>
