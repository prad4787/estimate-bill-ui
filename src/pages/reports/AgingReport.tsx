...
const AgingReport: React.FC = () => {
  ...
  //       if (daysPastDue <= 30) {
  //         agingAmounts.current += 0;
  //       } else if (daysPastDue <= 90) {
  //         agingAmounts.oneToThree += 0;
  //       } else if (daysPastDue <= 180) {
  //         agingAmounts.threeToSix += 0;
  //       } else if (daysPastDue <= 365) {
  //         agingAmounts.sixToTwelve += 0;
  //       } else {
  //         agingAmounts.overTwelve += 0;
  //       }
  //     });

  //     const total =
  //       agingAmounts.current +
  //       agingAmounts.oneToThree +
  //       agingAmounts.threeToSix +
  //       agingAmounts.sixToTwelve +
  ...
  // // Calculate totals
  // const totals = {
  //   current: filteredClientData.reduce(
  //     (sum, client) => sum + client.current,
  //     0
  //   ),
  //   oneToThree: filteredClientData.reduce(
  //     (sum, client) => sum + client.oneToThree,
  //     0
  //   ),
  //   threeToSix: filteredClientData.reduce(
  //     (sum, client) => sum + client.threeToSix,
  //     0
  //   ),
  //   sixToTwelve: filteredClientData.reduce(
  //     (sum, client) => sum + client.sixToTwelve,
  //     0
  //   ),
  //   overTwelve: filteredClientData.reduce(
  //     (sum, client) => sum + client.overTwelve,
  //     0
  //   ),
  ...
  //   a.href = url;
  //   a.download = `client-aging-report-${
  ...
  return (
    ...
    //           Track outstanding receivables by client across aging periods.
    //         </p>
    //       </div>
    //     </div>
    ...
    //             {filteredClientData.length} clients
    //           </p>
    //         </div>
    ...
    //           <p className="text-sm text-gray-500 mt-1">
    //             {totals.total > 0
    //               ? ((totals.oneToThree / totals.total) * 100).toFixed(1)
    //               : 0}
    //             %
    //           </p>
    //         </div>
    ...
    //           <h3 className="text-3xl font-bold text-red-600">
    //             {formatCurrency(
    //               totals.threeToSix + totals.sixToTwelve + totals.overTwelve
    //             )}
    //           </h3>
    //           <p className="text-sm text-gray-500 mt-1">
    //             {totals.total > 0
    ...
    //             Outstanding amounts by client across aging periods (
    //             {filteredClientData.length} clients)
    //           </p>
    //         </div>
    ...
    //                 client.overTwelve > 0
    //                   ? "bg-red-50"
    //                   : client.threeToSix > 0 || client.sixToTwelve > 0
    //                   ? "bg-yellow-50"
    //                   : ""
    //               }`}
    ...
    //                     {client.bills.length} unpaid bill
    //                     {client.bills.length !== 1 ? "s" : ""}
    //                   </div>
    //                 </div>
    //               </td>
    ...
    //                     {formatCurrency(client.oneToThree)}
    //                   </span>
    //                 ) : (
    //                   <span className="text-gray-400">-</span>
    //                 )}
    ...
    //                     {formatCurrency(client.threeToSix)}
    //                   </span>
    //                 ) : (
    //                   <span className="text-gray-400">-</span>
    //                 )}
    ...
    //                     {formatCurrency(client.sixToTwelve)}
    //                   </span>
    //                 ) : (
    //                   <span className="text-gray-400">-</span>
    //                 )}
    ...
    //                     {formatCurrency(client.overTwelve)}
    //                   </span>
    //                 ) : (
    //                   <span className="text-gray-400">-</span>
    //                 )}
